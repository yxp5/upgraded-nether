...
public class FieryShovelBase extends ShovelItem {

    public FieryShovelBase(ToolMaterial material) {
        super(material, 0.5f, -2.6f, new Settings().group(Main.BETTER_NETHER));
    }
